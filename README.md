...
**This repository has been deprecated and replaced by [monarch-project-copier](https://github.com/monarch-initiative/monarch-project-copier).**

**Please use the new repository for creating new Monarch Initiative projects.**
