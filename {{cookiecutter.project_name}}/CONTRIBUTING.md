...
To report a bug or suggest a new feature, please go to the [{{cookiecutter.github_org_name}}/{{cookiecutter.project_name}} issue tracker](https://github.com/{{cookiecutter.github_org_name}}/{{cookiecutter.project_name}}/issues), as we are
...
[issues]: https://github.com/{{ cookiecutter.github_org_name }}/{{ cookiecutter.project_name }}/issues/
[pulls]: https://github.com/{{ cookiecutter.github_org_name }}/{{ cookiecutter.project_name }}/pulls/
